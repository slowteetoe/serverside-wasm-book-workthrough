import { get, set } from 'component:smartcms-kvstore/kvstore';
...
const $init = (() => {
  let gen = (function* init () {
    ...
    const module1 = base64Compile('');
    ...
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      'component:smartcms-kvstore/kvstore': {
        get: exports0['0'],
        set: exports0['1'],
      },
    }));
